...
impl Display for DolphinError {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            DolphinError::Hungry => write!(f, "The dolphin is hungry."),
            DolphinError::TooYoung => write!(f, "The dolphin is too young."),
            DolphinError::LongName => {
                write!(f, "The dolphin's name is too long and annoying to say.")
            }
        }
    }
}
